<template>
  ...
  <div class="mb-0">
    ...
    <div class="d-flex align-items-center mb-9">
      ...
      <div class="d-flex align-items-center">
        <span class="ms-1" data-bs-toggle="tooltip" title="User replied">
          <KTIcon icon-name="check-circle" icon-class="text-success fs-1" />
        </span>
      </div>
      <!--end::Icons-->
    </div>
    ...
    <div class="d-flex flex-stack flex-wrap">
      ...
      <div class="d-flex align-items-center py-1">
        ...
        >
          23
          <KTIcon icon-name="black-right" icon-class="fs-7 ms-1 me-1" />
        </a>
      </div>
      <!--end::Info-->
    </div>
  ...
  <form id="kt_devs_reply_form" class="form mb-10" action="#">
    ...
    <div class="d-flex align-items-center justify-content-between py-2 mb-5">
      ...
      <div
        class="text-primary fs-base fw-semibold cursor-pointer"
...
import TextFormatting from "@/components/devs/TextFormatting.vue";
import LayoutService from "@/core/services/LayoutService";
import Replies from "@/components/devs/Replies.vue";
